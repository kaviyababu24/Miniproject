...
def send_mail_barcode(path):
    from_addr="srinidhi2829@gmail.com"
    SMTP_PASSWORD = 'ubrcwmcmcjngkgoz'
    # to_addr="srinidhi2829@gmail.com@gmail.com"
...
def login(request):
    while True:                                                 
        if request.method == "POST":
            ...
            con=pymysql.connect(db='barcode',host='localhost',user='root',password='admin',autocommit=True)
            cur =con.cursor()
            get=[]
